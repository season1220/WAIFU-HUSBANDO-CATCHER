...
# --- ADMIN COMMANDS (RUPLOAD, DELETE, ETC) ---
...
async def gift(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(f"🎁 Sent **{char['name']}**!")
...
async def fav(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(f"❤️ Favorite: {char['name']}")
...
async def check(update: Update, context: CallbackContext):
    ...
    if char.get('type') == 'amv':
        await update.message.reply_video(video=char['img_url'], caption=caption, parse_mode='Markdown', reply_markup=InlineKeyboardMarkup(btn))
    else:
...
async def send_shop_item(update: Update, context: CallbackContext):
    ...
    if update.callback_query:
        ...
        await context.bot.send_photo(chat_id=update.effective_chat.id, photo=char['img_url'], caption=caption, parse_mode='Markdown', reply_markup=InlineKeyboardMarkup(keyboard))
    else:
