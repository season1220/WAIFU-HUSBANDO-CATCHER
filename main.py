...
# --- NEW PRICES (Low = 500) ---
SHOP_PRICES = {
    "Low": 500, "Medium": 1000, "High": 2000, "Special Edition": 3000,
    "Elite Edition": 5000, "Legendary": 10000, "Valentine": 7000,
    "Halloween": 7000, "Winter": 7000, "Summer": 7000,
    "Royal": 15000, "Luxury": 25000, "Amv": 50000
}
...
async def shop_callback(update: Update, context: CallbackContext):
    ...
    if data == "shop_main":
        ...
        if crystals < price:
            await query.answer(f"❌ Need {price} Crystals!", show_alert=True)
            return
