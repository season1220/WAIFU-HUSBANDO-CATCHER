...
# --- UPDATED RARITY MAP (As per your list) ---
RARITY_MAP = {
    1: "🔸 Low",
    2: "🔷 Medium",
    3: "♦️ High",
...
async def shop_callback(update: Update, context: CallbackContext):
    ...
    if data == "shop_main":
        ...
        keyboard = [
            [InlineKeyboardButton("Contact to Buy", url="https://t.me/pari_xoxo")],
        ...
        # Grid Layout matching your Rarity List
        r1 = [
